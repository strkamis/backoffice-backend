package com.kamila.backofficeteste.services;
...
import com.kamila.backofficeteste.domain.enums.Perfil;
import com.kamila.backofficeteste.domain.enums.Prioridade;
import com.kamila.backofficeteste.domain.enums.Status;
import com.kamila.backofficeteste.repositories.ChamadoRepository;
import com.kamila.backofficeteste.repositories.PessoaRepository;

//como essa classe é uma service, precisa colocar essa notação, assim podemos passar as insrtancias em outras classes
@Service
public class DBService {
	
	// o spring fica responsavel por criar a instancia da class gerenciando e excluindo quando for preciso 
	@Autowired
